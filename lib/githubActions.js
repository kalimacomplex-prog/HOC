 ...
 * efêmero (workflow_dispatch) que faz o papel de "Maquina" da Nuvem de UMA
 * empresa — compartilhado pelas execuções dela, nunca mais de um por empresa
 * (ver lib/automationEngine.js::obterMaquinaEfemera). Mesma arquitetura do HAC (ver
